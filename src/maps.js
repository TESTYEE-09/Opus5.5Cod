...
export const MAPS = {
  ...
  crossroads: {
    ...
    look: {
      ...
      fog: 0xd8cbb0, fogNear: 90, fogFar: 520, exposure: 1.0, shadowSoft: 2, rays: 0.5,
  ...
  harbor: {
    ...
    look: {
      ...
      fog: 0xc09080, fogNear: 80, fogFar: 480, exposure: 1.12, pools: 0.45, poolColor: 0xffa050, shadowSoft: 2.5, rays: 0.8,
  ...
  outpost: {
    ...
    look: {
      ...
      fog: 0xc3ccd6, fogNear: 50, fogFar: 400, exposure: 1.05, shadowSoft: 4, rays: 0.3,
